...
/*
	...
	functions 		:		Defines the class running and generates run report base on historical data.
*/
class Running implements IQuery {
		...
		try {
			...
			$coordinateTo = null;
	 		...
	 		foreach($historical as $index => $unitData) {
	 				...
	 				//Updating flag
	 				if($unitData->io->speed > 0 && $unitData->io->acc == 1) {
	 					$statusNow = true;
	 				} else {
	 					$statusNow = false;
	 				}
