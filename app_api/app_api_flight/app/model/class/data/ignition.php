...
/*
	...
	functions 		:		Defines the class ignition and generates ignition report base on historical data.
*/
class Ignition implements IQuery {
		...
		try {
			...
			$coordinateTo = null;
	 		...
	 		foreach($historical as $index => $unitData) {
	 				...
	 				//First value
	 				// if ($index == 0) {
	 				// 	$dtFrom = $unitData->header->dtClient;
